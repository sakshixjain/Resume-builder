...
import { templateSupportsPhoto } from "@/lib/resume/presets";
import {
  User,
  Briefcase,
  Mail,
...
export const PersonalInfoForm: React.FC = () => {
  ...
  const supportsPhoto = templateSupportsPhoto(settings?.template);
  ...
  return (
    <div className="space-y-5">
      {/* Profile Photo / Avatar Upload Box (Only rendered for templates that display a photo) */}
      {supportsPhoto && (
